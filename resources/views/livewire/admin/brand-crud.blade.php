                    ...
                    <tbody class="">
                        @foreach ($brands as $brand)
                            <tr class="hover:bg-gray-100 text-center border">
                                ...
                                <td class="py-4 px-6">
                                  <p class="font-bold text-gray-700 text-lg">{{ $brand->brand_name }}</p>  
                                </td>
                                <td class="py-4 px-6">
                                    {{ $brand->brand_slug }}
                                </td>
                                <td class="py-4 px-6">
                                    {{ Str::limit($brand->brand_description,50) }}
                                </td>
                                ...
                                <td class="py-4 px-6">
                                    ...
                                    <div
                                        ...
                                        <button x-on:click="$wire.emit('editBrandTrigger',{{ $brand->id }})"
                                        ...
                                        <button
                                            x-on:click="deleteModal = true ,$wire.set('deletingBrandId','{{ $brand->id }}')"
