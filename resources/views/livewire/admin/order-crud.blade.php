                    ...
                    <tbody class="">
                        @foreach ($orders as $order)
                            <tr class="hover:bg-gray-100 text-center">
                                <td class="py-4 px-6">
                                    <p class="font-bold text-violet-800 hover:text-red-500"><a href="{{ route('order.detail',[$order->id]) }}">{{ $order->id }}</a></p>
                                </td>
                                <td class="py-4 px-6">
                                    <p class="font-bold text-gray-600 whitespace-nowrap">{{ number_format($order->total) }} تومان</p> 
                                </td>
                                <td class="py-4 px-6">
                                    <p>{{ strtoupper($order->firstname) }}</p> 
                                </td>
                                <td class="py-4 px-6">
                                    <p>{{ strtoupper($order->lastname) }}</p> 
                                </td>
                                <td class="py-4 px-6">
                                    <p class="underline text-green-700 font-bold"><a href="tel:{{ $order->line }}">{{ $order->line }}</a></p> 
                                </td>
                                <td class="py-4 px-6">
                                    <p class="underline text-blue-900 font-bold"><a href="mailto:{{ $order->email }}">{{ $order->email }}</a></p> 
                                </td>
                                <td class="py-4 px-6">
                                    <p>{{ $order->zipcode }}</p> 
                                </td>
                                ...
                                <td class="py-4 px-6">
                                    <div
                                        ...
                                        <button
                                            x-on:click="deleteModal = true ,$wire.set('deletingOrderId','{{ $order->id }}')"
