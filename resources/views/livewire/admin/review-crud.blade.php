                    ...
                    <tbody class="">
                        @foreach ($reviews as $review)
                            <tr class="hover:bg-gray-100 text-center">
                                ...
                                <td class="py-4 px-6">
                                   <p class="font-semibold text-green-600">{{ $review->email }}</p>
                                </td>
                                <td class="py-4 px-6">
                                   <p class="text-lg text-blue-800">{{ $review->comment }}</p>
                                </td>
                                ...
                                <td class="py-4 px-6">
                                    ...
                                    <div
                                        ...
                                        <button
                                            x-on:click="deleteModal = true ,$wire.set('deletingReviewId','{{ $review->id }}')"
