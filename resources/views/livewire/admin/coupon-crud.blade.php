                    ...
                    <tbody class="">
                        @foreach ($coupons as $coupon)
                            <tr class="hover:bg-gray-100 text-center">
                                ...
                                <td class="py-4 px-6">
                                   <p class="font-bold text-green-800">{{ $coupon->code }}</p> 
                                </td>
                                <td class="py-4 px-6">
                                ...
                                <td class="py-4 px-6">
                                    {{ number_format($coupon->value)}}{{$coupon->type == 'percent' ? '%' : ' تومان' }}
                                </td>
                                <td class="py-4 px-6">
                                  <p class="font-bold">{{ number_format($coupon->cart_value) }} تومان</p>  
                                </td>
                                <td class="py-4 px-6">
                                   <p class="text-red-500 font-bold">{{ $coupon->expiry_date->format('m') }} ماه مانده</p> 
                                </td>
                                ...
                                <td class="py-4 px-6">
                                    ...
                                    <div
                                        ...
                                        <button x-on:click="$wire.emit('editCouponTrigger',{{ $coupon->id }})"
                                        ...
                                        <button
                                            x-on:click="deleteModal = true ,$wire.set('deletingCouponId','{{ $coupon->id }}')"
