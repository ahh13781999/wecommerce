    ...
    <div class="space-y-6">
        ...
        <div class="w-full h-full bg-white overflow-x-auto">
            <div class="p-2 md:p-6 overflow-x-auto">
                    ...
                    <tbody class="">
                        @foreach ($homesliders as $homeslider)
                            <tr class="hover:bg-gray-100 text-center">
                                ...
                                <td class="py-4 px-6">
                                    {{ number_format($homeslider->price) }} <span class="font-bold">تومان</span>
                                </td>
                                <td class="py-4 px-6">
                                ...
                                <td class="py-4 px-6 font-medium">
                                    {{ $homeslider->created_at->diffForHumans() }}
                                </td>
                                <td class="py-4 px-6">

                                    <div
                                        class="flex flex-col md:flex-row items-stretch md:items-center justify-center gap-x-1 gap-y-1">
                                        <button x-on:click="$wire.emit('editHomeSliderTrigger',{{ $homeslider->id }})"
                                        ...
                                        <button
                                            x-on:click="deleteModal = true ,$wire.set('deletingHomeSliderId','{{ $homeslider->id }}')"
                ...
                {{ $homesliders->links('pagination.tailwind') }}
            </div>
        </div>
    </div>
