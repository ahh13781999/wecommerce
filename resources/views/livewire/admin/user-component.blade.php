                    ...
                    <tbody class="">
                        @foreach ($users as $user)
                            <tr class="hover:bg-gray-100 text-center">
                                ...
                                <td class="py-4 px-6">
                                   <p class="font-semibold text-gray-600">{{ $user->email }}</p>
                                </td>
                                <td class="py-4 px-6">
                                   @if ($user->status == 1)
                                      <p wire:click="editUser({{$user->id}})" class="text-center bg-green-500 py-2 px-2 rounded-full text-white font-bold text-lg cursor-pointer">عادی</p> 
                                   @else
                                      <p wire:click="editUser({{$user->id}})" class="text-center bg-orange-500 py-2 px-2 rounded-full text-white font-bold text-lg cursor-pointer">مسدود</p>
                                   @endif
                                </td>
                                ...
                                <td class="py-4 px-6">
                                    ...
                                    <div
                                        ...
                                        <button
                                            x-on:click="deleteModal = true ,$wire.set('deletingUserId','{{ $user->id }}')"
