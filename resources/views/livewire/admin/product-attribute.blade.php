    ...
    <div class="space-y-6">
        ...
        <div class="w-full h-full bg-white overflow-x-auto">
            <div class="p-2 md:p-6 overflow-x-auto">
                    ...
                    <tbody class="">
                        @foreach ($productAttributes as $productAttribute)
                            <tr class="hover:bg-gray-100 text-center">
                                ...
                                <td class="py-4 px-6">
                                  <p class="font-bold">{{ $productAttribute->name }}</p>  
                                </td>
                                <td class="py-4 px-6 font-medium">
                                    {{ $productAttribute->created_at->diffForHumans() }}
                                </td>
                                <td class="py-4 px-6">
                                    <div
                                        class="flex flex-col md:flex-row items-stretch md:items-center justify-center gap-x-1 gap-y-1">
                                        <button x-on:click="$wire.emit('editProductAttributeTrigger',{{ $productAttribute->id }})"
                                        ...
                                        <button
                                            x-on:click="deleteModal = true ,$wire.set('deletingProductAttributeId','{{ $productAttribute->id }}')"
                ...
                {{ $productAttributes->links('pagination.tailwind') }}
            </div>
        </div>
    </div>
