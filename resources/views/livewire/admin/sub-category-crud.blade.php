                    ...
                    <tbody class="">
                        @foreach ($subcategories as $subcategory)
                            <tr class="hover:bg-gray-100 text-center">
                                ...
                                <td class="py-4 px-6">
                                   <p class="font-bold">{{ $subcategory->subcategory_name }}</p>
                                </td>
                                <td class="py-4 px-6">
                                    {{ $subcategory->subcategory_slug }}
                                </td>
                                <td class="py-4 px-6">
                                   <p class="font-bold text-yellow-800">{{ $subcategory->category->category_name }}</p> 
                                </td>
                                ...
                                <td class="py-4 px-6">
                                    <div
                                        ...
                                        <button x-on:click="$wire.emit('editSubCategoryTrigger',{{ $subcategory->id }})"
                                        ...
                                        <button
                                            x-on:click="deleteModal = true ,$wire.set('deletingSubCategoryId','{{ $subcategory->id }}')"
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="md:col-span-6 col-span-6 space-y-4">
                                ...
                                <select wire:model="category_id" class="w-full bg-gray-50 rounded-lg border-gray-300 py-3 hover:border-teal-500 focus:ring-4 focus:ring-teal-500 focus:border-transparent" name="" id="">
                                    ...
                                    <option class="font-bold" x-bind="$wire.get('category_id') == {{ $category->id }} ? 'selected' : '' " value="{{ $category->id }}">{{ $category->category_name }}</option>                                        
                                    @endforeach
                                </select>
                                @error('category_id')
                                    <p class="rounded bg-red-200 text-red-600 py-2 px-4 text-base  ">
                    ...
                    <form wire:submit.prevent="createSubCategory">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="md:col-span-6 col-span-6 space-y-4">
                                ...
                                <select wire:model="category_id" class="w-full bg-gray-50 rounded-lg border-gray-300 py-3 hover:border-teal-500 focus:ring-4 focus:ring-teal-500 focus:border-transparent" name="" id="">
                                    @foreach ($categories as $category)
                                    <option class="font-bold" value="{{ $category->id }}">{{ $category->category_name }}</option>                                        
                                    @endforeach
                                </select>
                                @error('category_id')
                                    <p class="rounded bg-red-200 text-red-600 py-2 px-4 text-base  ">
