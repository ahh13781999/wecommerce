                    ...
                    <div class="col-span-12">
                        <div class="flex flex-col justify-between gap-y-4 w-full">
                            ...
                            <div class="flex flex-row justify-between w-full">
                                ...
                                <p class="text-xl font-bold">{{ number_format(session()->get('checkout')['subtotal']) }} تومان</p>
                            </div>
                            <div class="flex flex-row justify-between w-full">
                                <p class="text-gray-600 text-lg font-medium">هزینه ارسال</p>
                                <p class="text-xl font-bold">{{ number_format(session()->get('checkout')['tax']) }} تومان</p>
                            </div>
                            <div class="flex flex-row justify-between w-full">
                                <p class="text-gray-600 text-lg font-medium">تخفیف</p>
                                <p class="text-xl font-bold">{{ number_format(session()->get('checkout')['discount']) }} تومان</p>
                            </div>
                            <hr class="w-full">
                            <div class="flex flex-row justify-between w-full">
                                <p class="text-gray-600 text-lg font-medium">هزینه کل</p>
                                <p class="text-xl font-bold">{{ number_format(session()->get('checkout')['total']) }} تومان</p>
                            </div>
