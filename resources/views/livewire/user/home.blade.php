        ...
        <div class="flex flex-col items-center gap-y-6 my-8">
            ...
            <div class="flex flex-col items-center my-4 gap-y-4 w-full">
                <div class="flex-1 w-full">
                    <div class="owl-carousel owl-theme owl-loaded owl-two">@livewire('user.banner')</div>
                </div>
            </div>
            {{-- Banner --}}
            ...
            <div class="flex flex-col items-center gap-y-4 w-full">
                ...
                <div class="w-full border-2 bg-gray-100 h-full my-2">
                    <div class="owl-carousel owl-theme owl-loaded owl-one py-6">
                        @foreach ($newProducts->take(5) as $item)
                            <div
                                ...
                                <div class="w-56 h-56 inline-block my-2">
                                    <img src="{{ asset('product_thumbnail/' . $item->thumbnail_image) }}"
                                        alt="{{ $item->name }}">
                                </div>
            ...
            <div class="w-full border-2 bg-gray-100 h-full my-2">
                <div class="owl-carousel owl-theme owl-loaded owl-one py-6">
                    @foreach ($discountProducts->take(5) as $item)
                        <div
                            class="bg-white relative flex flex-col items-center justify-evenly hover:ring-2 hover:ring-red-500 hover:scale-110 transition h-[360px] my-6">
            ...
            <div class="flex flex-col items-center gap-y-4 w-full">
                ...
                <div class="w-full border-2 bg-gray-100 h-full my-2">
                    <div class="owl-carousel owl-theme owl-loaded owl-one py-6">
                        @foreach ($popularProducts->take(5) as $item)
                            <div
                                class="bg-white relative flex flex-col items-center justify-evenly hover:ring-2 hover:ring-red-500 hover:scale-110 transition h-[360px] my-6">
                ...
                <div class="flex md:flex-row flex-col md:items-center items-stretch text-center gap-x-[1px]">
                    @foreach ($categories->take(5) as $category)
                        <div
                            ...
                            <p class="text-lg font-bold">{{ $category->category_name }}</p>
                        </div>
                    @endforeach
                </div>
            </div>
                    ...
                    @foreach ($popularProducts->take(5) as $item)
                        <div
                            ...
                            <div class="absolute top-2 right-2 bg-pink-300 rounded-full px-2 py-1">
                                <p class="text-white font-bold">{{ $item->subcategory->subcategory_name }}</p>
                            </div>
                            <div class="w-56 h-56 inline-block">
                                <img src="{{ asset('product_thumbnail/' . $item->thumbnail_image) }}"
                                    alt="{{ $item->name }}">
