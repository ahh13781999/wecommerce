    ...
    <div class="space-y-6">
        <div class="flex flex-col items-start justify-between space-y-8 bg-white w-full px-4 py-6 md:px-6 md:py-8">
            <ul class="flex flex-row items-center gap-x-2 text-gray-900">
                ...
                <li class="flex flex-row items-center gap-x-2">
                    ...
                    <a class="font-bold" href="">زیر دسته بندی ها</a>
                </li>
            </ul>
            <h1 class="text-2xl font-bold">زیر دسته بندی ها</h1>
            <div
        ...
        <div class="w-full h-full bg-white overflow-x-auto">
            <div class="p-2 md:p-6 overflow-x-auto">
                ...
                <table class="border rounded-lg w-full overflow-x-auto">
                    <thead class="bg-gray-50 rounded-lg text-gray-500 text-center">
                        <tr class="">
                            ...
                            <th class="py-3 px-5 font-bold tracking-wide">
                                <a href="">نام زیر دسته بندی</a>
                            </th>
                            <th class="py-3 px-5 font-bold tracking-wide">
                                <a href="">اسلاگ زیر دسته بندی</a>
                            </th>
                            <th class="py-3 px-5 font-bold tracking-wide">
                                <a href="">دسته بندی</a>
                            </th>
                    ...
                    <tbody class="">
                        <?php $__currentLoopData = $subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-100 text-center">
                                ...
                                <td class="py-4 px-6">
                                   <p class="font-bold"><?php echo e($subcategory->subcategory_name); ?></p>
                                </td>
                                <td class="py-4 px-6">
                                    <?php echo e($subcategory->subcategory_slug); ?>

                                </td>
                                <td class="py-4 px-6">
                                   <p class="font-bold text-yellow-800"><?php echo e($subcategory->category->category_name); ?></p> 
                                </td>
                                <td class="py-4 px-6 font-medium">
                                    <?php echo e($subcategory->created_at->diffForHumans()); ?>

                                </td>
                                <td class="py-4 px-6">
                                    <div
                                        class="flex flex-col md:flex-row items-stretch md:items-center justify-center gap-x-1 gap-y-1">
                                        <button x-on:click="$wire.emit('editSubCategoryTrigger',<?php echo e($subcategory->id); ?>)"
                                        ...
                                        <button
                                            x-on:click="deleteModal = true ,$wire.set('deletingSubCategoryId','<?php echo e($subcategory->id); ?>')"
                ...
                <?php echo e($subcategories->links('pagination.tailwind')); ?>
        ...
        <div class="flex items-center justify-center w-full h-full overflow-y-auto overflow-x-hidden p-6"
            ...
            <div class="bg-white rounded-lg">
                <div class="flex justify-between items-center border-b-2 px-4 py-6">
                    <p class="text-xl font-bold">ادیت زیردسته بندی</p>
                    <svg x-on:click="$wire.emit('resetForm')" class="w-8 h-8 rounded-md cursor-pointer hover:bg-gray-200"
                    ...
                    <form wire:submit.prevent="editSubCategory">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="md:col-span-3 col-span-6 space-y-4">
                                <label class="font-medium text-lg  after:content-['*'] after:text-red-500 after:mr-1" for="">نام زیردسته بندی</label>
                                <input wire:model="subcategory_name" wire:keyup="generateSlug"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-3 col-span-6 space-y-4">
                                <label class="font-medium text-lg  after:content-['*'] after:text-red-500 after:mr-1" for="">اسلاگ زیردسته بندی</label>
                                <input wire:model="subcategory_slug"
                                    class="w-full bg-gray-50 rounded-lg border-gray-300 py-3 hover:border-teal-500 focus:ring-4 focus:ring-teal-500 focus:border-transparent"
                                    type="text">
                                <?php $__errorArgs = ['subcategory_slug'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-6 col-span-6 space-y-4">
                                <label class="font-medium text-lg after:content-['*'] after:text-red-500 after:mr-1" for="">دسته بندی</label>
                                <select wire:model="category_id" class="w-full bg-gray-50 rounded-lg border-gray-300 py-3 hover:border-teal-500 focus:ring-4 focus:ring-teal-500 focus:border-transparent" name="" id="">
                                                                        
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option class="font-bold" x-bind="$wire.get('category_id') == <?php echo e($category->id); ?> ? 'selected' : '' " value="<?php echo e($category->id); ?>"><?php echo e($category->category_name); ?></option>                                        
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="bg-white rounded-lg px-12 py-6">
                ...
                <div class="flex flex-col items-center justify-between gap-y-8">
                    ...
                    <div class="flex flex-row items-center justify-center gap-x-1">
                        <button x-on:click="$wire.emit('deleteSubCategory')"
    ...
    <div x-show="createModal" x-trap.inert.noscroll="createModal" id="createModal" x-transition:enter="ease-out delay-200 duration-500"
        ...
        <div class="flex items-center justify-center w-full h-full overflow-y-auto overflow-x-hidden p-6"
            ...
            <div class="bg-white rounded-lg">
                <div class="flex justify-between items-center border-b-2 px-4 py-6">
                    <p class="text-xl font-bold">ایجاد دسته بندی</p>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-6 col-span-6 space-y-4">
                                ...
                                <select wire:model="category_id" class="w-full bg-gray-50 rounded-lg border-gray-300 py-3 hover:border-teal-500 focus:ring-4 focus:ring-teal-500 focus:border-transparent" name="" id="">
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option class="font-bold" value="<?php echo e($category->id); ?>"><?php echo e($category->category_name); ?></option>                                        
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php $__errorArgs = ['category_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <button type="submit"
                                class="col-span-3 my-4 bg-teal-500 font-bold text-lg py-2 px-4 hover:bg-teal-700 rounded-lg text-white focus:ring-4 focus:ring-teal-300">
                                ذخیره
                            </button>
                        </div>
                    </form>
...
<?php /**PATH C:\laragon\www\Wcommerce - Copy\resources\views/livewire/admin/sub-category-crud.blade.php ENDPATH**/ ?>