    ...
    <div class="space-y-6">
        <div class="flex flex-col items-start justify-between space-y-8 bg-white w-full px-4 py-6 md:px-6 md:py-8">
            <ul class="flex flex-row items-center gap-x-2 text-gray-900">
                ...
                <li class="flex flex-row items-center gap-x-2">
                    ...
                    <a class="font-bold" href="">اسلاید ها</a>
                </li>
            </ul>
            <h1 class="text-2xl font-bold">اسلاید ها</h1>
            <div
        ...
        <div class="w-full h-full bg-white overflow-x-auto">
            <div class="p-2 md:p-6 overflow-x-auto">
                    ...
                    <tbody class="">
                        <?php $__currentLoopData = $homesliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $homeslider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-100 text-center">
                                ...
                                <td class="py-4 px-6">
                                    <?php echo e($homeslider->title); ?>

                                </td>
                                <td class="py-4 px-6">
                                    <?php echo e(number_format($homeslider->price)); ?> <span class="font-bold">تومان</span>
                                </td>
                                <td class="py-4 px-6">
                                    <?php if($homeslider->status): ?>
                                      <span class="rounded-full bg-green-400 text-white font-bold px-4 py-2">نمایش</span>
                                    <?php else: ?>
                                      <span class="rounded-full bg-red-400 text-white font-bold px-4 py-2">عدم نمایش</span>
                                    <?php endif; ?>
                                </td>
                                <td class="py-4 px-6 font-medium">
                                    <?php echo e($homeslider->created_at->diffForHumans()); ?>
                                ...
                                <td class="py-4 px-6">
                                    ...
                                    <div
                                        ...
                                        <button x-on:click="$wire.emit('editHomeSliderTrigger',<?php echo e($homeslider->id); ?>)"
                                        ...
                                        <button
                                            x-on:click="deleteModal = true ,$wire.set('deletingHomeSliderId','<?php echo e($homeslider->id); ?>')"
                ...
                <?php echo e($homesliders->links('pagination.tailwind')); ?>
        ...
        <div class="flex items-center justify-center w-full h-full overflow-y-auto overflow-x-hidden p-6"
            ...
            <div class="bg-white rounded-lg">
                <div class="flex justify-between items-center border-b-2 px-4 py-6">
                    <p class="text-xl font-bold">ادیت اسلاید</p>
                ...
                <div class="px-4 py-6">
                    <form wire:submit.prevent="editHomeSlider">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="md:col-span-3 col-span-6 space-y-4">
                                <label class="font-medium text-lg after:content-['*'] after:text-red-500 after:mr-1" for="">عنوان اسلاید</label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-3 col-span-6 space-y-4">
                                <label class="font-medium text-lg after:content-['*'] after:text-red-500 after:mr-1" for="">زیرعنوان اسلاید</label>
                                <input wire:model="subtitle" class="w-full bg-gray-50 rounded-lg border-gray-300 py-3 hover:border-teal-500 focus:ring-4 focus:ring-teal-500 focus:border-transparent" type="text">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-3 col-span-6 space-y-4">
                                <label class="font-medium text-lg after:content-['*'] after:text-red-500 after:mr-1" for="">قیمت</label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-3 col-span-6 space-y-4">
                                <label class="font-medium text-lg after:content-['*'] after:text-red-500 after:mr-1" for="">لینک</label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-3 col-span-6 space-y-4">
                                <label class="font-medium text-lg after:content-['*'] after:text-red-500 after:mr-1" for="">تصویر</label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-3 col-span-6 space-y-4">
                                <label class="font-medium text-lg after:content-['*'] after:text-red-500 after:mr-1" for="">وضعیت</label>
                                    <select wire:model="status" class="w-full bg-gray-50 rounded-lg border-gray-300 py-3 hover:border-teal-500 focus:ring-4 focus:ring-teal-500 focus:border-transparent">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="bg-white rounded-lg px-12 py-6">
                ...
                <div class="flex flex-col items-center justify-between gap-y-8">
                    ...
                    <h1 class="text-xl font-bold">
                        می خواهید این اسلاید را حذف کنید؟
                    </h1>
                    <div class="flex flex-row items-center justify-center gap-x-2">
                        <button x-on:click="$wire.emit('deleteHomeSlider')"
    ...
    <div x-show="createModal" x-trap.inert.noscroll="createModal" id="createModal" x-transition:enter="ease-out delay-200 duration-500"
        ...
        <div class="flex items-center justify-center w-full h-full overflow-y-auto overflow-x-hidden p-6"
            ...
            <div class="bg-white rounded-lg">
                <div class="flex justify-between items-center border-b-2 px-4 py-6">
                    <p class="text-xl font-bold">ایجاد اسلاید</p>
                ...
                <div class="px-4 py-6">
                    <form wire:submit.prevent="createHomeSlider">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="md:col-span-3 col-span-6 space-y-4">
                                <label class="font-medium text-lg after:content-['*'] after:text-red-500 after:mr-1" for="">عنوان اسلاید</label>
                                <input wire:model="title"
...
<?php /**PATH C:\laragon\www\Wcommerce - Copy\resources\views/livewire/admin/home-slider-crud.blade.php ENDPATH**/ ?>