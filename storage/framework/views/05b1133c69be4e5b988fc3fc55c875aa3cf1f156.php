...
<?php endif; ?>
    ...
    <div class="w-full h-screen overflow-hidden container mx-auto py-4 lg:py-10 px-6 lg:px-12">
        <div class="flex flex-row justify-start items-center gap-x-1 lg:gap-x-2 text-gray-800">
            ...
            <p class="font-semibold text-base lg:text-lg">ثبت نام</p>

        </div>
        <div class="w-full h-full flex flex-col justify-center items-center">
            <div class="border rounded shadow-xl p-8 w-full lg:w-1/2 xl:w-1/3">
                <form class="flex flex-col gap-y-8" action="<?php echo e(route('register')); ?>" method="post">
                    <p class="font-semibold text-gray-700 text-xl">در سایت ما ثبت نام کنید</p>
                    <?php echo csrf_field(); ?>
                    <fieldset class="flex flex-col gap-y-2">
                        <label class="w-full text-gray-600 font-medium text-lg" for="">نام</label>
                        <input name="name"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <fieldset class="flex flex-col gap-y-2">
                        <label class="w-full text-gray-600 font-medium text-lg" for="">تایید پسورد</label>
                        <input name="password_confirmation"
                            class="border-gray-200 focus:border-transparent hover:ring-2 hover:ring-red-500 focus:ring-4 focus:ring-red-500"
                            type="password">
                    </fieldset>
                    <fieldset class="flex flex-row">
                        <a class="font-semibold hover:text-red-500" href="<?php echo e(route('login')); ?>">از قبل ثبت نام کرده
                            اید؟</a>
                    </fieldset>
                    <fieldset>
                        <button
...
<?php /**PATH C:\laragon\www\Wcommerce - Copy\resources\views/auth/register.blade.php ENDPATH**/ ?>