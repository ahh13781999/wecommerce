    ...
    <div class="space-y-6">
        <div class="flex flex-col items-start justify-between space-y-8 bg-white w-full px-4 py-6 md:px-6 md:py-8">
            <ul class="flex flex-row items-center gap-x-2 text-gray-900">
                ...
                <li class="flex flex-row items-center gap-x-2">
                    ...
                    <a class="font-bold" href="">ویژگی محصول ها</a>
                </li>
            </ul>
            <h1 class="text-2xl font-bold">ویژگی محصول ها</h1>
            <div
        ...
        <div class="w-full h-full bg-white overflow-x-auto">
            <div class="p-2 md:p-6 overflow-x-auto">
                    ...
                    <tbody class="">
                        <?php $__currentLoopData = $productAttributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productAttribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-100 text-center">
                                ...
                                <td class="py-4 px-6">
                                  <p class="font-bold"><?php echo e($productAttribute->name); ?></p>  
                                </td>
                                <td class="py-4 px-6 font-medium">
                                    <?php echo e($productAttribute->created_at->diffForHumans()); ?>

                                </td>
                                <td class="py-4 px-6">
                                    <div
                                        class="flex flex-col md:flex-row items-stretch md:items-center justify-center gap-x-1 gap-y-1">
                                        <button x-on:click="$wire.emit('editProductAttributeTrigger',<?php echo e($productAttribute->id); ?>)"
                                        ...
                                        <button
                                            x-on:click="deleteModal = true ,$wire.set('deletingProductAttributeId','<?php echo e($productAttribute->id); ?>')"
                ...
                <?php echo e($productAttributes->links('pagination.tailwind')); ?>
        ...
        <div class="flex items-center justify-center w-full h-full overflow-y-auto overflow-x-hidden p-6"
            ...
            <div class="bg-white rounded-lg">
                <div class="flex justify-between items-center border-b-2 px-4 py-6">
                    <p class="text-xl font-bold">ادیت ویژگی محصول</p>
                ...
                <div class="px-4 py-6">
                    <form wire:submit.prevent="editProductAttribute">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 space-y-4">
                                <label class="font-medium text-lg  after:content-['*'] after:text-red-500 after:mr-1" for="">نام ویژگی محصول</label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="bg-white rounded-lg px-12 py-6">
                ...
                <div class="flex flex-col items-center justify-between gap-y-8">
                    ...
                    <h1 class="text-xl font-bold">
                        می خواهید این ویژگی محصول را حذف کنید؟
                    </h1>
                    <div class="flex flex-row items-center justify-center gap-x-2">
                        <button x-on:click="$wire.emit('deleteProductAttribute')"
    ...
    <div x-show="createModal" x-trap.inert.noscroll="createModal" id="createModal" x-transition:enter="ease-out delay-200 duration-500"
        ...
        <div class="flex items-center justify-center w-full h-full overflow-y-auto overflow-x-hidden p-6"
            ...
            <div class="bg-white rounded-lg">
                <div class="flex justify-between items-center border-b-2 px-4 py-6">
                    <p class="text-xl font-bold">ایجاد ویژگی محصول</p>
                ...
                <div class="px-4 py-6">
                    <form wire:submit.prevent="createProductAttribute">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 space-y-4">
                                <label class="font-medium text-lg after:content-['*'] after:text-red-500 after:mr-1" for="">نام ویژگی محصول</label>
                                <input wire:model="name"
...
<?php /**PATH C:\laragon\www\Wcommerce - Copy\resources\views/livewire/admin/product-attribute.blade.php ENDPATH**/ ?>