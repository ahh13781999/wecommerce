        ...
        <div class="flex flex-col items-start justify-between space-y-8 bg-white w-full px-4 py-6 md:px-6 md:py-8">
            <ul class="flex flex-row items-center gap-x-2 text-gray-900">
                ...
                <li class="flex flex-row items-center gap-x-2">
                    ...
                    <a class="font-bold" href="">کاربران</a>
                </li>
            </ul>
                    ...
                    <tbody class="">
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-100 text-center">
                                ...
                                <td class="py-4 px-6">
                                   <p class="font-semibold text-gray-600"><?php echo e($user->email); ?></p>
                                </td>
                                <td class="py-4 px-6">
                                   <?php if($user->status == 1): ?>
                                      <p wire:click="editUser(<?php echo e($user->id); ?>)" class="text-center bg-green-500 py-2 px-2 rounded-full text-white font-bold text-lg cursor-pointer">عادی</p> 
                                   <?php else: ?>
                                      <p wire:click="editUser(<?php echo e($user->id); ?>)" class="text-center bg-orange-500 py-2 px-2 rounded-full text-white font-bold text-lg cursor-pointer">مسدود</p>
                                   <?php endif; ?>
                                </td>
                                ...
                                <td class="py-4 px-6">
                                    ...
                                    <div
                                        ...
                                        <button
                                            x-on:click="deleteModal = true ,$wire.set('deletingUserId','<?php echo e($user->id); ?>')"
            ...
            <div class="bg-white rounded-lg px-12 py-6">
                ...
                <div class="flex flex-col items-center justify-between gap-y-8">
                    ...
                    <div class="flex flex-row items-center justify-center gap-x-2">
                        <button x-on:click="$wire.emit('deleteUser')"
...
<?php /**PATH C:\laragon\www\Wcommerce - Copy\resources\views/livewire/admin/user-component.blade.php ENDPATH**/ ?>