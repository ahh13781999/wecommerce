...
} elseif ($_instance->childHasBeenRendered('l1553778138-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1553778138-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1553778138-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1553778138-0');
} else {
    $response = \Livewire\Livewire::mount('user.banner');
    $html = $response->html();
    $_instance->logRenderedChild('l1553778138-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    ...
                    <div class="grid grid-cols-12 gap-x-4 gap-y-6 py-8 px-4">
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div
                                class="col-span-12 md:col-span-6 lg:col-span-4 bg-white cursor-pointer rounded relative hover:ring-red-300 hover:ring">
...
<?php /**PATH C:\laragon\www\Wcommerce - Copy\resources\views/livewire/user/sub-category-component.blade.php ENDPATH**/ ?>