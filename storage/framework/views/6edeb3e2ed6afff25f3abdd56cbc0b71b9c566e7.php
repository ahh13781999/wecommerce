        ...
        <div class="flex flex-col items-start justify-between space-y-8 bg-white w-full px-4 py-6 md:px-6 md:py-8">
            <ul class="flex flex-row items-center gap-x-2 text-gray-900">
                ...
                <li class="flex flex-row items-center gap-x-2">
                    ...
                    <a class="font-bold" href="">سفارشات</a>
                </li>
            </ul>
                    ...
                    <tbody class="">
                        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-100 text-center">
                                <td class="py-4 px-6">
                                    <p class="font-bold text-violet-800 hover:text-red-500"><a href="<?php echo e(route('order.detail',[$order->id])); ?>"><?php echo e($order->id); ?></a></p>
                                </td>
                                <td class="py-4 px-6">
                                    <p class="font-bold text-gray-600 whitespace-nowrap"><?php echo e(number_format($order->total)); ?> تومان</p> 
                                </td>
                                <td class="py-4 px-6">
                                    <p><?php echo e(strtoupper($order->firstname)); ?></p> 
                                </td>
                                <td class="py-4 px-6">
                                    <p><?php echo e(strtoupper($order->lastname)); ?></p> 
                                </td>
                                <td class="py-4 px-6">
                                    <p class="underline text-green-700 font-bold"><a href="tel:<?php echo e($order->line); ?>"><?php echo e($order->line); ?></a></p> 
                                </td>
                                <td class="py-4 px-6">
                                    <p class="underline text-blue-900 font-bold"><a href="mailto:<?php echo e($order->email); ?>"><?php echo e($order->email); ?></a></p> 
                                </td>
                                <td class="py-4 px-6">
                                    <p><?php echo e($order->zipcode); ?></p> 
                                </td>
                                <td class="py-4 px-6">
                                    <?php switch($order->status):
                                        case ("ordered"): ?>
                                        <p class="bg-purple-500 rounded-lg py-2 px-4 text-white font-semibold whitespace-nowrap">پرداخت شده</p> 
                                            <?php break; ?>
                                        <?php case ("deliverd"): ?>
                                        <p class="bg-cyan-500 rounded-lg py-2 px-4 text-white font-semibold whitespace-nowrap">تحویل داده شده</p> 
                                            <?php break; ?>
                                        <?php case ("canceled"): ?>
                                        <p class="bg-orange-500 rounded-lg py-2 px-4 text-white font-semibold whitespace-nowrap">کنسل شده</p> 
                                            <?php break; ?>
                                        <?php default: ?>
                                         <p class="bg-gray-500 rounded-lg py-2 px-4 text-white font-semibold whitespace-nowrap">نامعلوم</p>    
                                     <?php endswitch; ?> 
                                </td>
                                ...
                                <td class="py-4 px-6">
                                    <div
                                        ...
                                        <button
                                            x-on:click="deleteModal = true ,$wire.set('deletingOrderId','<?php echo e($order->id); ?>')"
            ...
            <div class="bg-white rounded-lg px-12 py-6">
                ...
                <div class="flex flex-col items-center justify-between gap-y-8">
                    ...
                    <h1 class="text-xl font-bold">
                        می خواهید این سفارش را حذف کنید؟
                    </h1>
                    <div class="flex flex-row items-center justify-center gap-x-2">
                        <button x-on:click="$wire.emit('deleteOrder')"
...
<?php /**PATH C:\laragon\www\Wcommerce - Copy\resources\views/livewire/admin/order-crud.blade.php ENDPATH**/ ?>