        ...
        <div x-intersect="elem = true" x-data="{ elem: false }" class="relative p-6 border">
            <div class="w-5/6 mx-auto">
                <img x-show="elem" x-transition:enter="duration-1000 transition ease-out"
                    ...
                    src="<?php echo e(asset('home_slider/' . $banner->image)); ?>" alt="<?php echo e($banner->title); ?>">
            </div>
            ...
            <a x-show="elem" href="<?php echo e($banner->link); ?>" target="_blank"
...
<?php /**PATH C:\laragon\www\Wcommerce - Copy\resources\views/livewire/user/banner.blade.php ENDPATH**/ ?>