                                ...
                                <tr class="hover:bg-gray-100 text-center">
                                    ...
                                    <td class="py-4 px-6">
                                        <p class="bg-blue-200 text-white font-bold rounded-full py-2 px-2">
                                            <?php echo e($product->brand->brand_name); ?></p>
                                    </td>
                                    <td class="py-4 px-6">
                                        <p class="font-bold text-orange-800"><?php echo e($product->subcategory->category->category_name); ?></p>
                                    </td>
                                    <td class="py-4 px-6">
                                       <p class="font-bold text-pink-600"><?php echo e($product->subcategory->subcategory_name); ?></p>
                                    </td>
                                    ...
                                    <td class="py-4 px-6">
                                        ...
                                        <div
                                            ...
                                            <button
                                                wire:click.prevent="$emit('editProductTrigger',<?php echo e($product->id); ?>)"
                                            ...
                                            <button wire:click.prevent="$set('deletingProductId',<?php echo e($product->id); ?>)"
                                ...
                                <div class="md:col-span-3 col-span-6 space-y-4">
                                    ...
                                    <select wire:model.defer="brand_id"
                                        ...
                                        <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option
                                                x-bind="$wire.get('brand_id') == <?php echo e($brand->id); ?> ? 'selected' : '' "
                                    ...
                                    <select wire:model.defer="sub_category_id"
                                        ...
                                        <?php $__currentLoopData = $subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($subcategory->id); ?>">
                                                <span class="text-sm text-gray-400"><?php echo e($subcategory->category->category_name); ?> - </span>
                                ...
                                <div class="col-span-6 space-y-4">
                                        ...
                                        <select wire:model="Attr"
                                            ...
                                            <?php $__currentLoopData = $productAttributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productAttribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($productAttribute->id); ?>">
                                                    <?php echo e($productAttribute->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    ...
                                    <?php $__currentLoopData = $Inputs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex flex-col gap-y-2">
                                            <label
                                                class="font-medium text-lg after:content-['*'] after:text-red-500 after:mr-1"
                                                for=""><?php echo e($productAttribute->whereId($Attribute_Array[$key])->first()->name); ?></label>
                                            <div class="flex flex-row items-stretch ">
                                                <input wire:model="Attribute_Values.<?php echo e($value); ?>"
                                                    class="w-full bg-gray-50 rounded-lg border-gray-300 py-3 hover:border-teal-500 focus:ring-4 focus:ring-teal-500 focus:border-transparent"
                                                    type="text"
                                                    placeholder="<?php echo e($productAttribute->whereId($Attribute_Array[$key])->first()->name); ?>">
                                                <button wire:click.prevent="removeAttribute(<?php echo e($key); ?>)"
...
<?php /**PATH C:\laragon\www\Wcommerce - Copy\resources\views/livewire/admin/product-crud.blade.php ENDPATH**/ ?>