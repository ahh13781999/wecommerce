<div>
    <div x-data class="w-full h-full container mx-auto py-4 lg:py-10 px-4 lg:px-12">
        <div class="flex flex-row justify-start items-center gap-x-1 lg:gap-x-2 text-gray-800">
            ...
            <p class="font-semibold text-base lg:text-lg"><?php echo e($sub_category->category->category_name); ?></p>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7" />
            </svg>
            <p class="font-semibold text-base lg:text-lg"><?php echo e($sub_category->subcategory_name); ?></p>
        </div>
                            ...
                            <ul x-data>
                                ...
                                <div x-ref="subcategory" class="hidden">
                                    <?php $__currentLoopData = $category->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="text-base font-bold text-stone-400 hover:bg-gray-200 p-1 my-2 <?php if(Request::segment(2) == $subcategory->subcategory_slug){ echo "bg-gray-300 text-black"; } ?>">
                                            <a href="<?php echo e(route('sub-category', ['slug' => $subcategory->subcategory_slug])); ?>">-
...
} elseif ($_instance->childHasBeenRendered('l2476430815-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2476430815-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2476430815-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2476430815-0');
} else {
    $response = \Livewire\Livewire::mount('user.banner');
    $html = $response->html();
    $_instance->logRenderedChild('l2476430815-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        ...
                        <div class="bg-gray-200 py-2 px-4 w-full mt-6">
                            <div class="flex flex-row items-center justify-between">
                                <h2 class="text-xl font-semibold"><?php echo e($sub_category->subcategory_name); ?></h2>
...
<?php /**PATH C:\laragon\www\Wcommerce\resources\views/livewire/user/sub-category-component.blade.php ENDPATH**/ ?>