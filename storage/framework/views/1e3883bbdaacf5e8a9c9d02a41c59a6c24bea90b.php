<footer class="flex flex-col w-full">
    ...
    <div class="bg-red-500">
        <div class="flex flex-row items-center justify-center container mx-auto">
            <div
                class="grid grid-cols-12 text-white font-semibold w-full py-6 gap-y-4">
                <div class="col-span-12 md:col-span-6 xl:col-span-3 flex flex-col items-center justify-center text-center gap-2 py-2 px-4">
            ...
            <div class="grid grid-cols-6 gap-y-4 gap-x-0 lg:gap-y-0 lg:gap-x-4 w-full">
                <div class="flex flex-col space-y-4 col-span-6 lg:col-span-3 text-lg">
                    ...
                    <div class="flex flex-row items-center gap-2">
                        ...
                        <a href="tel:+2133442255" dir="ltr">(+21) 33442255</a>
                    </div>
                    <div class="flex flex-row items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 flex-shrink-0" viewBox="0 0 20 20"
                            fill="currentColor">
                        ...
                        <a href="mailto:wcommerce@email.com">wcommerce@email.com</a>
                    </div>
                </div>
...
</footer><?php /**PATH C:\laragon\www\Wcommerce - Copy\resources\views/components/user-footer.blade.php ENDPATH**/ ?>