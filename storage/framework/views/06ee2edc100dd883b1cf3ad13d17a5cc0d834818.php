<?php if($paginator->hasPages()): ?>
    <nav role="navigation" aria-label="<?php echo e(__('Pagination Navigation')); ?>" class="flex flex-row items-center justify-center my-4">
        <div class="flex flex-row items-center justify-center flex-1 sm:hidden">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:flex-row sm:items-center sm:justify-center">
            <div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Wcommerce - Copy\resources\views/pagination/tailwind.blade.php ENDPATH**/ ?>