...
} elseif ($_instance->childHasBeenRendered('KZSeEkw')) {
    $componentId = $_instance->getRenderedChildComponentId('KZSeEkw');
    $componentTag = $_instance->getRenderedChildComponentTagName('KZSeEkw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KZSeEkw');
} else {
    $response = \Livewire\Livewire::mount('user.header');
    $html = $response->html();
    $_instance->logRenderedChild('KZSeEkw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\laragon\www\Wcommerce - Copy\resources\views/components/user-header.blade.php ENDPATH**/ ?>