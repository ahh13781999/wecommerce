<div>
    <div x-data class="w-full h-full container mx-auto py-4 lg:py-10 px-4 lg:px-12">
        <div class="flex flex-row justify-start items-center gap-x-1 lg:gap-x-2 text-gray-800">
            ...
            <p class="font-semibold text-base lg:text-lg"><?php echo e($main_category->category_name); ?></p>
        </div>
                ...
                <div class="col-span-12 lg:col-span-3 flex flex-col items-start gap-y-8">
                    <ul class="flex flex-col gap-y-2 w-full border-b-2 pb-6">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <ul x-data>
                                <div class="flex flex-row justify-between text-lg font-medium text-gray-700 hover:text-red-500">
                                    <p><?php echo e($category->category_name); ?><span> (<?php echo e($category->products()->count()); ?>)</span></p> 
                                    <svg x-on:click="$refs.subcategory.classList.toggle('hidden')" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 cursor-pointer" fill="none"
                                ...
                                <?php $__currentLoopData = $category->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="text-base font-bold text-stone-400 hover:bg-gray-200 p-1 my-2"><a
                                            href="<?php echo e(route('sub-category', ['slug' => $subcategory->subcategory_slug])); ?>">- <?php echo e($subcategory->subcategory_name); ?></a>
                                    </li>
                        ...
                        <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="flex flex-row justify-between items-center">
                                <div class="inline-flex gap-x-1">
                                   ...
                                   <span class="text-lg font-semibold text-slate-500">(<?php echo e($brand->products->count()); ?>)</span> 
                                </div>
                                <input
...
} elseif ($_instance->childHasBeenRendered('l1674330934-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1674330934-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1674330934-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1674330934-0');
} else {
    $response = \Livewire\Livewire::mount('user.banner');
    $html = $response->html();
    $_instance->logRenderedChild('l1674330934-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        <div class="bg-gray-200 py-2 px-4 w-full mt-6">
                            <div class="flex flex-row items-center justify-between">
                                <h2 class="text-xl font-semibold"><?php echo e($main_category->category_name); ?></h2>
                    ...
                    <div class="grid grid-cols-12 gap-x-4 gap-y-6 py-8 px-4">
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div
                                class="col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-3 bg-white cursor-pointer rounded relative hover:ring-red-300 hover:ring">
                                <div class="flex flex-col items-center justify-between gap-y-2 h-full">
                                    ...
                                    <div class="gap-y-1 flex flex-col items-center">
                                        ...
                                        <?php else: ?>
                                            <p class="text-lg font-bold"><?php echo e(number_format($product->regular_price)); ?>
                                ...
                                <?php if($wishListItems->contains($product->id)): ?>
                                    <svg wire:click.prevent="removeFromWishlist(<?php echo e($product->id); ?>)"
                                ...
                                <?php else: ?>
                                    <svg wire:click.prevent="addToWishlist(<?php echo e($product->id); ?>,'<?php echo e($product->name); ?>',<?php echo e($product->off_price ?? $product->regular_price); ?>)"
                                        xmlns="http://www.w3.org/2000/svg"
...
<?php /**PATH C:\laragon\www\Wcommerce\resources\views/livewire/user/category-component.blade.php ENDPATH**/ ?>