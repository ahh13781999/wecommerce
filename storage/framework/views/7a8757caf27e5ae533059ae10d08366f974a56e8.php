...
} elseif ($_instance->childHasBeenRendered('l2351092289-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2351092289-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2351092289-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2351092289-0');
} else {
    $response = \Livewire\Livewire::mount('user.banner');
    $html = $response->html();
    $_instance->logRenderedChild('l2351092289-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></div>
                </div>
                ...
                <div class="w-full border-2 bg-gray-100 h-full my-2">
                    <div class="owl-carousel owl-theme owl-loaded owl-one py-6">
                        <?php $__currentLoopData = $newProducts->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div
                                class="bg-white relative flex flex-col items-center justify-evenly hover:ring-2 hover:ring-red-500 hover:scale-110 transition h-[360px] my-6">
                                <div class="absolute top-2 right-2 bg-orange-500 rounded-full px-2 py-1">
                                    <p class="text-white font-bold">جدید</p>
                                </div>
                                <div class="w-56 h-56 inline-block my-2">
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\Wcommerce - Copy\resources\views/livewire/user/home.blade.php ENDPATH**/ ?>