        ...
        <div class="flex flex-col items-start justify-between space-y-8 bg-white w-full px-4 py-6 md:px-6 md:py-8">
            <ul class="flex flex-row items-center gap-x-2 text-gray-900">
                ...
                <li class="flex flex-row items-center gap-x-2">
                    ...
                    <a class="font-bold" href="">دسته بندی ها</a>
                </li>
            </ul>
                ...
                <table class="border rounded-lg w-full overflow-x-auto">
                    <thead class="bg-gray-50 rounded-lg text-gray-500 text-center">
                        <tr class="">
                            ...
                            <th class="py-3 px-5 font-bold tracking-wide">
                                <a href="">نام دسته بندی</a>
                            </th>
                            <th class="py-3 px-5 font-bold tracking-wide">
                                <a href="">اسلاگ دسته بندی</a>
                            </th>
                            <th class="py-3 px-5 font-bold tracking-wide">
                                <a href="">ایجاد شده</a>
                            </th>
                    ...
                    <tbody class="">
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-100 text-center">
                                ...
                                <td class="py-4 px-6">
                                   <p class="font-bold"><?php echo e($category->category_name); ?></p>
                                </td>
                                <td class="py-4 px-6">
                                    <p><?php echo e($category->category_slug); ?></p> 
                                </td>
                                ...
                                <td class="py-4 px-6">
                                    ...
                                    <div
                                        ...
                                        <button x-on:click="$wire.emit('editCategoryTrigger',<?php echo e($category->id); ?>)"
                                        ...
                                        <button
                                            x-on:click="deleteModal = true ,$wire.set('deletingCategoryId','<?php echo e($category->id); ?>')"
        ...
        <div class="flex items-center justify-center w-full h-full overflow-y-auto overflow-x-hidden p-6"
            ...
            <div class="bg-white rounded-lg">
                <div class="flex justify-between items-center border-b-2 px-4 py-6">
                    <p class="text-xl font-bold">ادیت دسته بندی</p>
                    ...
                    <form wire:submit.prevent="editCategory">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="md:col-span-3 col-span-6 space-y-4">
                                <label class="font-medium text-lg  after:content-['*'] after:text-red-500 after:mr-1" for="">نام دسته بندی</label>
                                <input wire:model="category_name" wire:keyup="generateSlug"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-3 col-span-6 space-y-4">
                                <label class="font-medium text-lg  after:content-['*'] after:text-red-500 after:mr-1" for="">اسلاگ دسته بندی</label>
                                <input wire:model="category_slug"
                                    class="w-full bg-gray-50 rounded-lg border-gray-300 py-3 hover:border-teal-500 focus:ring-4 focus:ring-teal-500 focus:border-transparent"
                                    type="text">
            ...
            <div class="bg-white rounded-lg px-12 py-6">
                ...
                <div class="flex flex-col items-center justify-between gap-y-8">
                    ...
                    <div class="flex flex-row items-center justify-center gap-x-2">
                        <button x-on:click="$wire.emit('deleteCategory')"
...
<?php /**PATH C:\laragon\www\Wcommerce - Copy\resources\views/livewire/admin/category-crud.blade.php ENDPATH**/ ?>