    ...
    <div class="space-y-6">
        <div class="flex flex-col items-start justify-between space-y-8 bg-white w-full px-4 py-6 md:px-6 md:py-8">
            <ul class="flex flex-row items-center gap-x-2 text-gray-900">
                ...
                <li class="flex flex-row items-center gap-x-2">
                    ...
                    <a class="font-bold" href="">برند ها</a>
                </li>
            </ul>
            <h1 class="text-2xl font-bold">برند ها</h1>
            <div
        ...
        <div class="w-full h-full bg-white overflow-x-auto">
            <div class="p-2 md:p-6 overflow-x-auto">
                ...
                <table class="border rounded-lg w-full overflow-x-auto">
                    ...
                    <tbody class="">
                        <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-100 text-center border">
                                <td class="py-4 px-6"><input type="checkbox"
                                        class="bg-gray-100 rounded hover:bg-teal-800 focus:bg-teal-500 focus:ring-teal-500 checked:bg-teal-500 checked:hover:bg-teal-800 checked:focus:bg-teal-500 h-5 w-5 ">
                                </td>
                                <td class="py-4 px-6">
                                  <p class="font-bold text-gray-700 text-lg"><?php echo e($brand->brand_name); ?></p>  
                                </td>
                                <td class="py-4 px-6">
                                    <?php echo e($brand->brand_slug); ?>

                                </td>
                                <td class="py-4 px-6">
                                    <?php echo e(Str::limit($brand->brand_description,50)); ?>
                                ...
                                <td class="py-4 px-6">
                                    ...
                                    <div
                                        ...
                                        <button x-on:click="$wire.emit('editBrandTrigger',<?php echo e($brand->id); ?>)"
                                        ...
                                        <button
                                            x-on:click="deleteModal = true ,$wire.set('deletingBrandId','<?php echo e($brand->id); ?>')"
                ...
                <?php echo e($brands->links('pagination.tailwind')); ?>
        ...
        <div class="flex items-center justify-center w-full h-full overflow-y-auto overflow-x-hidden p-6"
            ...
            <div class="bg-white rounded-lg">
                <div class="flex justify-between items-center border-b-2 px-4 py-6">
                    <p class="text-xl font-bold">ادیت برند</p>
                    ...
                    <form wire:submit.prevent="editBrand">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="md:col-span-3 col-span-6 space-y-4">
                                <label class="font-medium text-lg  after:content-['*'] after:text-red-500 after:mr-1" for="">نام برند</label>
                                <input wire:model="brand_name" wire:keyup="generateSlug"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-3 col-span-6 space-y-4">
                                <label class="font-medium text-lg  after:content-['*'] after:text-red-500 after:mr-1" for="">اسلاگ برند</label>
                                <input wire:model="brand_slug"
                                    class="w-full bg-gray-50 rounded-lg border-gray-300 py-3 hover:border-teal-500 focus:ring-4 focus:ring-teal-500 focus:border-transparent"
                                    type="text">
                                <?php $__errorArgs = ['brand_slug'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-span-6 space-y-4">
                                <label class="font-medium text-lg after:content-['*'] after:text-red-500 after:mr-1" for="">توضیحات برند</label>
                                <textarea wire:model="brand_description" class="w-full bg-gray-50 rounded-lg border-gray-300 py-3 hover:border-teal-500 focus:ring-4 focus:ring-teal-500 focus:border-transparent" cols="30" rows="10"></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="bg-white rounded-lg px-12 py-6">
                ...
                <div class="flex flex-col items-center justify-between gap-y-8">
                    ...
                    <h1 class="text-xl font-bold">
                        می خواهید این برند را حذف کنید؟
                    </h1>
                    <div class="flex flex-row items-center justify-center gap-x-2">
                        <button x-on:click="$wire.emit('deleteBrand')"
    ...
    <div x-show="createModal" x-trap.inert.noscroll="createModal" id="createModal" x-transition:enter="ease-out delay-200 duration-500"
        ...
        <div class="flex items-center justify-center w-full h-full overflow-y-auto overflow-x-hidden p-6"
            ...
            <div class="bg-white rounded-lg">
                <div class="flex justify-between items-center border-b-2 px-4 py-6">
                    <p class="text-xl font-bold">ایجاد برند</p>
...
<?php /**PATH C:\laragon\www\Wcommerce - Copy\resources\views/livewire/admin/brand-crud.blade.php ENDPATH**/ ?>