...
} elseif ($_instance->childHasBeenRendered('l1096022301-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1096022301-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1096022301-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1096022301-0');
} else {
    $response = \Livewire\Livewire::mount('user.banner');
    $html = $response->html();
    $_instance->logRenderedChild('l1096022301-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    ...
                    <div class="grid grid-cols-12 gap-x-4 gap-y-6 py-8 px-4">
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div
                                class="col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-3 bg-white rounded relative hover:ring-red-300 hover:ring">
...
<?php /**PATH C:\laragon\www\Wcommerce\resources\views/livewire/user/shop.blade.php ENDPATH**/ ?>